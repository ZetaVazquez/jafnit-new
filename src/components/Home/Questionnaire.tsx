...
const Questionnaire: React.FC<QuestionnaireProps> = ({ onComplete, onClose }) => {
  ...
  const questions: QuestionnaireQuestion[] = [
    ...
    {
      id: '7',
      step: '🗂️ Paso 7: Datos básicos de contacto',
      question: 'Déjanos tus datos para poder contactarte y comenzar tu proceso.',
      type: 'form',
      required: true,
      fields: [
        ...
        { name: 'main_objective', label: 'Objetivo', type: 'select', required: true, options: ['Pérdida de grasa', 'Ganancia muscular', 'Recomposición corporal', 'Rendimiento deportivo', 'Mejorar salud y energía'] },
