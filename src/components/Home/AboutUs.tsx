  ...
  return (
    <section id="about" className="py-20 dynamic-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Main content area with new layout according to the sketch */}
        <div className="relative max-w-7xl mx-auto">
          {/* Top Left Testimonial */}
          <div className="absolute top-0 left-0 transform -translate-x-8 -translate-y-8 z-30 hidden lg:block">
            <div className={`${testimonials[0].rotation} transform hover:scale-105 transition-all duration-300 hover:z-40`}>
              <div className="bg-nutrition-green-light p-4 rounded-2xl shadow-2xl border-4 border-white max-w-64 backdrop-blur-sm">
                <div className="flex items-center mb-3">
                  <img src={testimonials[0].image} alt={testimonials[0].name} className="w-10 h-10 rounded-full mr-3 border-2 border-white" />
                  <span className="font-bold text-sm text-nutrition-green-dark">{testimonials[0].name}</span>
                </div>
                <p className="text-sm text-nutrition-green-darker leading-tight font-medium">{testimonials[0].text}</p>
              </div>
            </div>
          </div>

          {/* Top Right Testimonial */}
          <div className="absolute top-8 right-0 transform translate-x-12 -translate-y-12 z-30 hidden lg:block">
            <div className={`${testimonials[1].rotation} transform hover:scale-105 transition-all duration-300 hover:z-40`}>
              <div className="bg-nutrition-green p-4 rounded-2xl shadow-2xl border-4 border-white max-w-64 backdrop-blur-sm">
                <div className="flex items-center mb-3">
                  <img src={testimonials[1].image} alt={testimonials[1].name} className="w-10 h-10 rounded-full mr-3 border-2 border-white" />
                  <span className="font-bold text-sm text-white">{testimonials[1].name}</span>
                </div>
                <p className="text-sm text-white leading-tight font-medium">{testimonials[1].text}</p>
              </div>
            </div>
          </div>

          {/* Bottom Left Testimonial */}
          <div className="absolute bottom-8 left-0 transform -translate-x-12 translate-y-12 z-30 hidden lg:block">
            <div className={`${testimonials[2].rotation} transform hover:scale-105 transition-all duration-300 hover:z-40`}>
              <div className="bg-nutrition-green p-4 rounded-2xl shadow-2xl border-4 border-white max-w-64 backdrop-blur-sm">
                <div className="flex items-center mb-3">
                  <img src={testimonials[2].image} alt={testimonials[2].name} className="w-10 h-10 rounded-full mr-3 border-2 border-white" />
                  <span className="font-bold text-sm text-white">{testimonials[2].name}</span>
                </div>
                <p className="text-sm text-white leading-tight font-medium">{testimonials[2].text}</p>
              </div>
            </div>
          </div>

          {/* Bottom Right Testimonial */}
          <div className="absolute bottom-0 right-0 transform translate-x-8 translate-y-8 z-30 hidden lg:block">
            <div className={`${testimonials[3].rotation} transform hover:scale-105 transition-all duration-300 hover:z-40`}>
              <div className="bg-nutrition-green-light p-4 rounded-2xl shadow-2xl border-4 border-white max-w-64 backdrop-blur-sm">
                <div className="flex items-center mb-3">
                  <img src={testimonials[3].image} alt={testimonials[3].name} className="w-10 h-10 rounded-full mr-3 border-2 border-white" />
                  <span className="font-bold text-sm text-nutrition-green-dark">{testimonials[3].name}</span>
                </div>
                <p className="text-sm text-nutrition-green-darker leading-tight font-medium">{testimonials[3].text}</p>
              </div>
            </div>
          </div>
