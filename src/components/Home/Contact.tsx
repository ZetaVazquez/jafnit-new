        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-bold text-nutrition-black mb-1">Teléfono</h4>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-bold text-nutrition-black mb-1">Email</h4>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h4 className="font-bold text-nutrition-black mb-1">Dirección</h4>
            ...
            <div className="pt-8 border-t">
              <div className="bg-nutrition-green bg-opacity-10 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  <Calendar className="w-6 h-6 text-nutrition-green mr-3" />
                  <h4 className="font-bold text-nutrition-black">¿Reservamos una cita?</h4>
                </div>
