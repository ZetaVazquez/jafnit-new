  ...
  return (
    <div className={`relative overflow-hidden ${className}`} style={{
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="geometric-shape circle-shape w-28 h-28 top-20 right-10 animate-float"></div>
        <div className="geometric-shape circle-shape w-22 h-22 bottom-10 right-1/3 animate-pulse-slow"></div>
        ...
        <div className="geometric-shape circle-shape w-16 h-16 top-1/6 right-1/2 animate-bounce-gentle"></div>
        <div className="geometric-shape circle-shape w-20 h-20 bottom-1/4 left-1/6 animate-pulse-slow"></div>
        ...
        <div className="geometric-shape circle-shape w-14 h-14 bottom-1/6 right-2/3 animate-float"></div>
        <div className="geometric-shape circle-shape w-8 h-8 top-2/3 right-1/6 animate-pulse-slow"></div>
        ...
        <div className="geometric-shape triangle-shape triangle-down top-1/2 left-1/6 animate-rotate-slow"></div>
        <div className="geometric-shape triangle-shape triangle-up bottom-1/3 right-1/6 animate-float"></div>
      </div>
