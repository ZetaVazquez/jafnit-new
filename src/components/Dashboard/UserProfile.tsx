...
const UserProfile: React.FC<UserProfileProps> = ({ onGoBack }) => {
  ...
  return (
    <div className="min-h-screen bg-[hsl(220,20%,8%)]">
      ...
      <PlanRecommendationModal isOpen={showPlansModal} onClose={() => setShowPlansModal(false)} onDecideLater={() => setShowPlansModal(false)} recommendedPlan="constructor" fromQuestionnaire={false} redirectOnClose={false} />
